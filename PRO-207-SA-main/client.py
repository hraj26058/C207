...
def gameWindow():
    ...
    winingMessage = canvas2.create_text(screen_width/2 + 10, screen_height/4 - 100, text = "", font=("Chalkboard SE",40), fill='#fff176')
    ...
    dice = canvas2.create_text(screen_width/2 + 10, screen_height/2 + 130, text = "\u2680", font=("Chalkboard SE",250), fill="white")
...
def handleWin(message):
    ...
    resetButton.place(x=screen_width / 2 - 80, y=screen_height/2  + 250)
